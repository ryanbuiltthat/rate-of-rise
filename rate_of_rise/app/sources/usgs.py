...
gauges that actually publish continuous instantaneous values:
  ...
  * 01534860 — a receiving river downstream (~7 mi SE). An adjacent
    basin, but it drains the same upstream upland that forms the creek's upstream half —
    so it sees roughly *our* rain, and its rise is the closest available analog for how
    that upland responds.
  * 01534000 — a receiving creek in an adjacent basin (~11 mi W). The receiving system
