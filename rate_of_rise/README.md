...
2. The **Rate of Rise** card appears in the store. Open it and **Install**
...
(under a *Rate of Rise* device) — no package or config edit, and they update with
