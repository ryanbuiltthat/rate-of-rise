...
So "Creek Flood Probability" on the "Creek Modeling" device becomes
`sensor.creek_modeling_creek_flood_probability`. Most entities here hide the
...
class DiscoveryPublisher:
    ...
    def entity_ids(self) -> dict[str, str]:
        ...
        honoured here. So "Creek NWS Alert Feed Missing" on the "Creek Modeling"
        device becomes `binary_sensor.creek_modeling_creek_nws_alert_feed_missing`,
